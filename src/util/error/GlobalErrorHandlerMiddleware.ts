...
import { Err, MiddlewareMethods, ResponseErrorObject, Middleware, Req, Res } from '@tsed/common';
...
@Middleware()
export class GlobalErrorHandlerMiddleware implements MiddlewareMethods {
  @Constant('env')
  env: Env;
